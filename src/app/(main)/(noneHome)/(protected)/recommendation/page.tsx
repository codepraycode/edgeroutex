...
import { RecommendationFormData, SlideConfig, ValidationRule } from "@/types/form.types";
...
const RecommendationPage: React.FC = () => {
    ...
    return (
        <div className="p-6 pt-10">
            <SlideContainer<RecommendationFormData>
                slides={slides}
                initialData={{
                    transportMode: [],
                    infrastructure: "",
                ...
                onComplete={(data) => {
                    ...
                    // Here you can process → generate roadmap, recommendations, PDF export, etc.
                }}
                className="mb-20"
            />
        </div>
